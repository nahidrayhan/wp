...
element.addEventListener('mouseenter',function(){mouseEntered=true;cursorWrapper.classList.add('active');activeElements.forEach(function(activeEl){activeEl.classList.remove('active');});activeElements.push(cursorWrapper);});element.addEventListener('mouseleave',function(){mouseEntered=false;cursorWrapper.classList.remove('active');activeElements.pop();activeElements.forEach(function(activeEl){activeEl.classList.add('active');});});element.addEventListener('pointermove',function(){if(!mouseEntered){mouseEntered=true;cursorWrapper.classList.add('active');activeElements.forEach(function(activeEl){activeEl.classList.remove('active');});activeElements.push(cursorWrapper);}
